#!/usr/bin/env python3
"""
Balanced Multi-Objective Optimization for Python
...
def main():
    output_dir = "results/python_full"
    os.makedirs(output_dir, exist_ok=True)

    client = ModelAPIClient()
    config = load_config()

    dataset_path = "datasets/python.jsonl"
    python_data = load_dataset(dataset_path)

    print("=" * 70)
    print("Python Full Dataset Evaluation")
    print("=" * 70)
    print(f"Dataset: {dataset_path} ({len(python_data)} samples)")
    print("Using best config from optimization: T=0.10, max_tokens=56")
    print("Targets:")
    print("  - ES >= 0.7")
    print("  - EM >= 0.25")
    print("  - Accuracy >= 0.55")
    ...
    print()
    print("=" * 70)
    print("PYTHON FULL DATASET RESULTS")
    print("=" * 70)
